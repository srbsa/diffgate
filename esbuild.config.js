...
await esbuild.build({
  ...
  target: "node18",
  outfile: "dist/cli.js",
  external: ["fsevents", "chokidar", "@babel/parser", "web-tree-sitter", "tree-sitter-python", "tree-sitter-php", "tree-sitter-go", "tree-sitter-ruby", "tree-sitter-java", "tree-sitter-c-sharp"],
