---
description: Triage the current diff with DiffGate — grades each changed line green/yellow/orange by impact. Use when the user asks to review, triage, or gate their current changes before committing or opening a PR.
---
